...
def get_weather_data(lat, lon):
    url = f"https://weather.visualcrossing.com/VisualCrossingWebServices/rest/services/timeline/{lat},{lon}/last50days?unitGroup=metric&include=days&key={get_APIKEY()}&contentType=json"
...
def get_averages(data):
    ...
    averages['rainfall'] = averages['rainfall'] * 7.3
